...
print(f"\nGiven what you know about \"{top_words}\", I want to trade the market today and I want you to analyze some of the current news headlines I have harvested to make a decision on how to trade. You can choose to buy a specific financial instrument (should you think it best) or recommend a general market. Trade recommendations that you have are to buy long or sell short, based on the research I will provide you. Try to pick out specific details in the information I provide which may translate into a great trading opportunity. Overall, the sentiment appears it could be {sentiment_decision} based on my research of the news headlines, but I may be wrong. Here are the headlines (each headline starts with headline:) that are important for this analysis: {news}\n\n")
